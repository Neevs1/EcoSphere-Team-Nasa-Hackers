...
export function DepartmentsTab() {
  ...
  const { data, isLoading } = useDepartments(debouncedSearch, page);

  const columns = [
    { key: "name", header: "Name" },
    { key: "code", header: "Code" },
    { key: "employee_count", header: "Employees", render: (r: any) => r.employee_count ?? 0 },
    {
      key: "status",
      header: "Status",
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-h4 font-medium text-foreground">Departments</h2>
